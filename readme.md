...
As an additional experiment, Gaussian noise was injected into the token embeddings during training to investigate its effect on generation quality.

The intuition is similar to image augmentation: small perturbations preserve semantic information while encouraging the model to learn more robust representations instead of memorizing exact embedding vectors.
...
The Gaussian Noise version tends to produce slightly more diverse and coherent generations while achieving a marginally lower training loss in this experiment. This is presented as an exploratory regularization experiment rather than a definitive improvement.
